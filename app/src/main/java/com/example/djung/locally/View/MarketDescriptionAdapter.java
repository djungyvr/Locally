...
public class MarketDescriptionAdapter extends RecyclerView.Adapter<MarketDescriptionAdapter.ViewHolder> implements OnMapReadyCallback {
    private ArrayList<Market> markets;
    private Context context;
    private GoogleMap googleMap;
    private LatLng latLng;

    public MarketDescriptionAdapter(ArrayList<Market> markets, Context context) {
    ...
    @Override
    public void onBindViewHolder(MarketDescriptionAdapter.ViewHolder holder, int position) {
